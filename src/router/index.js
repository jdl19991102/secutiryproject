...
/* Information */
const Information = _import("infomation/Information");
const Article = _import("infomation/Article");

/* Market */
const Market = _import("market/Market");
/* Mine */
const Mine = _import("mine/Mine");
Vue.use(Router);
